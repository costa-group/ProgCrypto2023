...
template Edwards2Montgomery() {
    signal input {edwards} in[2];
    signal output {montgomery} out[2];
...
template Montgomery2Edwards() {
    signal input {montgomery} in[2];
    signal output {edwards} out[2];
...
template MontgomeryAdd() {
    signal input {montgomery} in1[2];
    signal input {montgomery}in2[2];
    signal output {montgomery}  out[2];
